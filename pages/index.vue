            ...
            <vue-horizontal class="horizontal">
                <div class="item" v-for="item in items" :key="item.id">
                    <div class="card">
                        <div class="wrapper">
                            <div class="image"
                                :style="{ background: `url(https://www.legaltoday.com/wp-content/uploads/2022/01/jurado.jpg)` }">
                            </div>
  ...
  data() {
    return {
      ...
      items: [...Array(20).keys()].map((i) => {
        return {title: `Servicio ${i}`, description: `🚀 Content ${i} asiuhdliquwhdilquwhdo uqiwuhdoi uqwhgdoiqu whgiduhq iwoudhqiwuh douhwqd ouwqh odwuh oi`};
      }),
    }
  },
  components: {
